...
> ⚠️ **Python 3.14+**: Los scripts de arranque intentan descargar binarios precompilados de `pydantic` y `pydantic-core`. Si no existen builds para tu versión, verás un mensaje indicando que instales Python 3.13.x para garantizar la compatibilidad.
